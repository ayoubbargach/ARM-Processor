if { ![project_exists {writeback}] } {
     project_new {writeback}
} else {
     project_open {writeback}
}
set_project_settings -cmp {writeback}
if { ![project_settings_exist -sim writeback] } {
        set_project_settings -sim writeback
}
set_global_assignment -section_id {writeback} -name {EDA_DESIGN_ENTRY_SYNTHESIS_TOOL} {PRECISION SYNTHESIS}
set_global_assignment -name {VQM_FILE} {writeback.vqm}
...
if { [file exists {writeback_altera.prop}] } {
  source writeback_altera.prop
}
set_global_assignment -name {FAMILY} {CYCLONE II}
set_global_assignment -section_id {writeback} -name {DEVICE} {EP2C70F896I8}
set_global_assignment -name {PROJECT_SHOW_ENTITY_NAME} {OFF}
set_global_assignment -name {SDC_FILE} {writeback_pnr_constraints.sdc}
