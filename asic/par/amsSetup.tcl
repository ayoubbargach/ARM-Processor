...
proc amsSetMMMC {} {
    ...
    create_rc_corner -name ams_rc_corner_typ \
            -cap_table {/softslin/AMS_410_CDS/cds/HK_C35/LEF/encounter/c35b4_thick-typical.capTable} \
            -preRoute_res {1.0} \
            -postRoute_res {1.0} \
            -preRoute_cap {1.0} \
            -postRoute_cap {1.0} \
            -postRoute_xcap {1.0} \
            -qx_tech_file {/softslin/AMS_410_CDS/assura/c35b4/c35b4thickall/RCX-typical/qrcTechFile}
    print "---#   rc_corner        : ams_rc_corner_typ"
    create_rc_corner -name ams_rc_corner_wc \
            -cap_table {/softslin/AMS_410_CDS/cds/HK_C35/LEF/encounter/c35b4_thick-worst.capTable} \
            -preRoute_res {1.0} \
            -postRoute_res {1.0} \
            -preRoute_cap {1.0} \
            -postRoute_cap {1.0} \
            -postRoute_xcap {1.0} \
            -qx_tech_file {/softslin/AMS_410_CDS/assura/c35b4/c35b4thickall/RCX-worst/qrcTechFile}
    print "---#   rc_corner        : ams_rc_corner_wc"
    create_rc_corner -name ams_rc_corner_bc \
            -cap_table {/softslin/AMS_410_CDS/cds/HK_C35/LEF/encounter/c35b4_thick-best.capTable} \
            -preRoute_res {1.0} \
            -postRoute_res {1.0} \
            -preRoute_cap {1.0} \
            -postRoute_cap {1.0} \
            -postRoute_xcap {1.0} \
            -qx_tech_file {/softslin/AMS_410_CDS/assura/c35b4/c35b4thickall/RCX-best/qrcTechFile}
    print "---#   rc_corner        : ams_rc_corner_bc"

    create_library_set -name libs_min -timing { \
               /softslin/AMS_410_CDS/liberty/c35_3.3V/c35_CORELIB_BC.lib \
               /softslin/AMS_410_CDS/liberty/c35_3.3V/c35_IOLIB_BC.lib \
    }
    create_library_set -name libs_max -timing { \
               /softslin/AMS_410_CDS/liberty/c35_3.3V/c35_CORELIB_WC.lib \
               /softslin/AMS_410_CDS/liberty/c35_3.3V/c35_IOLIB_WC.lib \
    }
    create_library_set -name libs_typ -timing { \
               /softslin/AMS_410_CDS/liberty/c35_3.3V/c35_CORELIB_TYP.lib \
               /softslin/AMS_410_CDS/liberty/c35_3.3V/c35_IOLIB_TYP.lib \
   }
